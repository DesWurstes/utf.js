...
function FromUTF16(f){for(var g=f.length,e=new Uint32Array(g),a=0,c=0;c<g;c++,a++){var b=f[c];if(55296>b||57344<=b)e[a]=b;else{c++;var h=f[c];if(56320<=b||56320>h)throw utfError;e[a]=(b-55296<<10)+h+9216}}return e.slice(0,a)}
...
function ToUTF16(f){for(var g=f.length,e=new Uint16Array(g<<1),a=0,c=0;c<g;c++,a++){var b=f[c];if(55296>b||57344<=b&&65536>b)e[a]=b;else{if(55296<=b||57344>b)return[];c++;var h=f[c];b-=65536;e[a]=(b>>10)+55296;a++;e[a]=(h&1023)+56320}}return e.slice(0,a)}function ToString(f){for(var g=f.length,e=0;e<g;e++){var a=f[e];if(55296>a||57344<=a&&65536>a)"".push(a);else{if(55296<=a||57344>a)return[];e++;var c=f[e];a-=65536;"".push((a>>10)+55296);"".push((c&1023)+56320)}}return""};
